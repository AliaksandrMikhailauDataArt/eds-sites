...
## Environments
- Preview: https://main--eds-sites--AliaksandrMikhailauDataArt.aem.page/
- Live: https://main--eds-sites--AliaksandrMikhailauDataArt.aem.live/
...
1. Open the `eds-sites` directory in your favorite IDE and start coding :)
